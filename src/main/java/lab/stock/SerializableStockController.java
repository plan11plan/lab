...
public class SerializableStockController {

    private final SerializableStockService service;
    ...
    public ResponseEntity<Integer> rangeSelectSleep(@RequestParam(defaultValue = "A") String tag,
                                                    ...
                                                    @RequestParam(defaultValue = "5000") long sleep) {
        return ResponseEntity.ok(service.rangeSelectThenSleep("TX-" + tag, lo, hi, sleep));
    }
